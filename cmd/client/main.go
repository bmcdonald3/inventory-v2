...
Examples:
  # Create from stdin
  echo '{"deviceType": "example-value", "manufacturer": "example-value", "partNumber": "example-value", "serialNumber": "example-value", "parentID": "example-value", "properties": {"{"key":"value"}": "value"}}' | client device create

  # Create with --spec flag
  client device create --spec '{"deviceType": "example-value", "manufacturer": "example-value", "partNumber": "example-value", "serialNumber": "example-value", "parentID": "example-value", "properties": {"{"key":"value"}": "value"}}'
...
Examples:
  # Update from stdin
  echo '{"deviceType": "example-value", "manufacturer": "example-value", "partNumber": "example-value", "serialNumber": "example-value", "parentID": "example-value", "properties": {"{"key":"value"}": "value"}}' | client device update <uid>

  # Update with --spec flag
  client device update <uid> --spec '{"deviceType": "example-value", "manufacturer": "example-value", "partNumber": "example-value", "serialNumber": "example-value", "parentID": "example-value", "properties": {"{"key":"value"}": "value"}}'
